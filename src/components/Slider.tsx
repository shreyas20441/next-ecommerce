...
const slides = [
    ...
    {
      id: 3,
      title: "Winter Sales Collections",
      description: "Sale! Up to 50% off!",
          ...
          {slides.map(slide =>(
            <div className={`${slide.bg} w-screen h-full flex flex-col gap-16 xl:flex-row`} key={slide.id}>
              ...
              text-center ">
                ...
                <Link className="rounded-md bg-black text-white py-3 px-4" href={slide.url}><button>SHOP NOW</button></Link>
              </div>
              {/**Img Container */}
